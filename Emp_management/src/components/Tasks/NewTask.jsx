  ...
  return (
    <div className="h-full w-[300px] shrink-0 bg-blue-500 rounded-xl">
      <div className=" flex justify-between items-center">
        <h3 className="bg-red-600 px-3 py-1 ml-1 mt-1 rounded-xl">
          {task.category}
        </h3>
      ...
      <div className="flex flex-col px-2 mt-5 gap-3">
        ...
        <p className=" text-lg font-medium">{task.taskDescription}</p>
      </div>

      <div className=" flex justify-center items-center ml-1 mr-2">
        <button 
        className=" mt-4 ml-2 bg-green-500 rounded-lg px-2 py-1 w-auto text-medium font-medium active:scale-95">
          Accept
        </button>
      </div>
    </div>
