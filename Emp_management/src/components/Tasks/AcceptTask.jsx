  ...
  return (
    <div className="h-full w-[300px] shrink-0 bg-yellow-500 rounded-xl" >
          ...
          <div className=' flex justify-between items-center ml-1 mr-2'>
            ...
            className=' mt-4 ml-2 bg-green-500 rounded-lg px-2 py-1 w-auto text-sm font-medium active:scale-95'>Mark as Completed</button>

            <button 
             onClick={() => onRetry(task.id)}
            className=' mt-4 ml-2 bg-red-500 rounded-lg px-2 py-1 w-auto text-sm font-medium active:scale-95'> Mark as Failed</button>
          </div>
        </div>
  )
}
